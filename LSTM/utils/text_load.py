...
class Corpus(object):
    def __init__(self, args, dictionary):
        ...
        self.path = f'/data/Reddit'
        authors_no = 100
        self.local_test_perc = args.local_test_perc
        ...
        self.train, self.test, self.diff_words, self.voc_size = self.tokenize_train(f'/data/Reddit/shard_by_author')

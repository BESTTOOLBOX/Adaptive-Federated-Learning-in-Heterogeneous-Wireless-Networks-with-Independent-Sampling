...
public class MainActivity extends AppCompatActivity {
    ...
    private Button LocalTrainButton;
    private TextView resultText;
    private EditText device_id;
    private EditText LocalTrainEpoch;
    ...
    private static class LogcatThread extends Thread {
        ...
        public LogcatThread(MainActivity activity) {
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
                switch (msg.what) {
                    case 1:
                        activity.setResultText((String) msg.obj);
                        break;
                }
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalTrainEpoch = (EditText) findViewById(R.id.LocalTrainEpoch);
        ...
        LocalTrainButton = (Button) findViewById(R.id.TrainLocal);

        fc = new FlowerClient(this);

        myHandler = new MyHandler(this);

        LogcatThread thread = new LogcatThread(this);
        thread.start();
    }
            ...
            executor.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        result =  "Training dataset is loaded in memory.1";
                    } catch (Exception e) {
                        StringWriter sw = new StringWriter();
                        PrintWriter pw = new PrintWriter(sw);
                        e.printStackTrace(pw);
                        pw.flush();
                        result =  "Training dataset is loaded in memory.2";
                    }
                    handler.post(() -> {
    ...
    public void localTrain(View view){

        setResultText("Start Training...");
        MainActivity activity = this;
        if (TextUtils.isEmpty(LocalTrainEpoch.getText().toString())) {
            Toast.makeText(this, "Please enter local epochs", Toast.LENGTH_LONG).show();
        }
        else{
            ExecutorService executor = Executors.newSingleThreadExecutor();
            Handler handler = new Handler(Looper.getMainLooper());
            ...
            public void run() {
                ...
                Pair<ByteBuffer[], Integer> outputs = activity.fc.fit(weights, Integer.parseInt(LocalTrainEpoch.getText().toString()));
